...
<!--                <a href="javascript:;" class="item-del-btn" @click="delSelectItem">-->
<!--                  删除所有-->
<!--                </a>-->
<!--              </div>-->
            </div>
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" v-bind:class="{'btn--dis':checkedCount==0}" @click="checkOut">提交订单</a>
              </div>
            </div>
          </div>
        </div>
